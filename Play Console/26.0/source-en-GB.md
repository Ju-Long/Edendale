# Store listing — source copy (en-GB, default)

This is the master text for the Google Play store listing. Edit it here, then
regenerate the CSVs (see [README.md](README.md)) before importing.

Character limits are enforced by Google Play. Current usage is shown in
parentheses.
...
## Full description (4000 max — 1773)

```
Edendale is a free, open-source video player and personal watch tracker for the movies and shows you already own. Point it at your own files, imported folders, or a supported network source, and Edendale builds a private library you control — no streaming catalogue, no subscription, and no Edendale account.
